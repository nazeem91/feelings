...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = os.environ['SwRwPDBW7SACak8AW0GenWjbt']
        consumer_secret = os.environ['HkECKsdUg7PtizzwAX50gwMHb7xjzNUnJEx1UUO9ovbfaLksXi']
        access_token = os.environ['712760194502098945-Ldh6EPLUFMUgrbHQGM62lpSUhloxdoO']
        access_token_secret = os.environ['C6SRFiccvzKoYYWYgB4CNsgFMmZH8OLr7OUVqiCk4AT5h']
